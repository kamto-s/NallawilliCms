...
{
    /// <inheritdoc />
    public partial class CmsPagesSectionsAndGuidPosts : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // SQL Server cannot ALTER int IDENTITY → uniqueidentifier. Recreate posts/categories (data loss).
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PropertyBag = table.Column<string>(type: "nvarchar(max)", nullable: false),
